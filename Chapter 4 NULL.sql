...
-- 4.1. Fitering for NULL in queries 
...
SELECT * FROM Employees WHERE ManageID IS NULL;
SELECT * FROM Employees WHERE ManageID IS NOT NULL;
...
-- 4.2. Nullable columns in tables 
...
-- 4.4. Insrting rows with NULL fields 
